...
public class Account_info extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_ledgers = new javax.swing.JButton();
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1100, 160, -1, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel8.setText("Account Info.");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(1100, 190, -1, -1));

        btn_groups.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btn_groups.setText("Groups");
        getContentPane().add(btn_groups, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 270, -1, -1));

        btn_ledgers.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btn_ledgers.setText("Ledgers");
        btn_ledgers.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_ledgersActionPerformed(evt);
            }
        });
        getContentPane().add(btn_ledgers, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 320, -1, -1));

        btn_vouchers_type.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btn_vouchers_type.setText("Vouchers types");
        getContentPane().add(btn_vouchers_type, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 390, -1, -1));
        ...
        getContentPane().add(btn_quit, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 500, -1, -1));
    ...
    private void btn_ledgersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ledgersActionPerformed
        // TODO add your handling code here:
        new ledgers().setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btn_ledgersActionPerformed
    ...
    private javax.swing.JButton btn_ledgers;
